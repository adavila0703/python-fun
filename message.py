from random import shuffle
 # define the card value and suits
...
def card_value(card):
    """Returns the integer vallue of a single card."""
...
while player_in:
    ...
    # If the player's hand is a bust, don't ask them for a decision.
    ...
    if player_in:
        ...
        # player_in to false, and move on to the dealers hand.0
        if response:
            player_in = True
